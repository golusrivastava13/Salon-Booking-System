...
import com.salonbooking.repository.ServiceOfferingRepository;
...
public class ServiceOfferingServiceImpl implements ServiceOfferingService {
    ...
    @Override
    public ServiceOffering createService(SalonDTO salonDTO, ServiceDTO serviceDTO,
    ...
    @Override
    public Set<ServiceOffering> getAllServiceBySalonId(long salongId, Long categoryId) {
        Set<ServiceOffering> services=serviceOfferingRepository
                .findBySalonId(salongId);
        if(categoryId!=null){
